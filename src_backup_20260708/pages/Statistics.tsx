...
export const Statistics = ({ onBack, selectedDate, onShowCalendar, onDateChange }: StatisticsProps) => {
      ...
      <div className="px-4 -mt-5">
        <div className="bg-white rounded-2xl shadow-lg p-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center p-5 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl shadow-sm">
              <p className="text-gray-500 text-sm font-medium">本月收入</p>
              <p className="text-2xl font-bold text-emerald-600 mt-2">
                {formatCurrencyShort(monthIncome)}
              </p>
            </div>
            <div className="text-center p-5 bg-gradient-to-br from-red-50 to-red-100 rounded-2xl shadow-sm">
              <p className="text-gray-500 text-sm font-medium">本月支出</p>
          ...
          <div className="mt-5 p-5 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-sm">
            <p className="text-gray-500 text-sm text-center font-medium">本月结余</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-5 mt-4">
          <h2 className="text-lg font-semibold text-gray-800 mb-5">支出分布</h2>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-5 mt-4">
          <h2 className="text-lg font-semibold text-gray-800 mb-5">收入分布</h2>
          {incomeData.length > 0 ? (
            <div className="flex flex-col items-center">
              <ResponsiveContainer width="100%" height={240}>
                <PieChart>
            ...
            <div className="text-center py-12 text-gray-400">
              ...
              <p className="text-gray-500">暂无收入数据</p>
            </div>
          )}
        </div>

        <div className="bg-white rounded-2xl shadow-lg p-5 mt-4 mb-4">
          <div className="flex items-center justify-between mb-5">
            <h2 className="text-lg font-semibold text-gray-800">收支趋势</h2>
            <button
              onClick={() => setShowFullYear(!showFullYear)}
              className="px-4 py-2 text-emerald-500 text-sm font-medium bg-emerald-50 rounded-full hover:bg-emerald-100 active:bg-emerald-200 transition-all flex items-center gap-1"
            >
