...
export const Categories = ({ onViewCategoryDetail, onBack }: CategoriesProps) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      <div className="bg-white px-6 pt-8 pb-6">
        ...
        <p className="text-gray-400 text-sm mt-2 leading-relaxed">管理您的收支分类</p>
      </div>
            ...
            {expenseCategories.map((category) => {
              ...
              return (
                <button
                  ...
                  className="flex flex-col items-center p-3 bg-gray-50 rounded-xl relative group hover:bg-gray-100 active:bg-gray-200 transition-all duration-200 min-h-[80px]"
                >
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
